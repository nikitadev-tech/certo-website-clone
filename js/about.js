...
const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            if (entry.target.classList.contains('history__slider')) {
...
document.querySelectorAll('.history__slider, [data-animation]').forEach(element => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Бургер-меню элементы:", { burgerBtn, mobileMenu });
    ...
    if (burgerBtn && mobileMenu) {
        ...
        console.error("Бургер-меню элементы не найдены!");
        console.error("burgerBtn:", burgerBtn);
